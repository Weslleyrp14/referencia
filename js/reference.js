...
define('text!tpl/menu.html',[],function () { return '<p>\n  <small>\n    Está pagina está sendo constantemente atualizada com novos comandos, fique de olho! \nTem alguma duvida? Dê uma olhada </span>\n    <a href="https://escoladeinventor.com.br/">aqui</a></small>\n</p>\n\n<% var i=0; %>\n<% var max=Math.floor(groups.length/4); %>\n<% var rem=groups.length%4; %>\n\n<% _.each(groups, function(group){ %>\n  <% var m = rem > 0 ? 1 : 0 %>\n  <% if (i === 0) { %>\n    <dl>\n  <% } %>\n  <dd><a href="#group-<%=group%>"><%=group%></a></dd>\n  <% if (i === (max+m-1)) { %>\n    </dl>\n  \t<% rem-- %>\n  \t<% i=0 %>\n  <% } else { %>\n  \t<% i++ %>\n  <% } %>\n<% }); %>';});
